...
setwd("C:\\Users\\whard\\OneDrive\\Desktop\\Reproducible research\\RR_classes\\RR_classes\\may_1014")
```
...
One potential goal is to identify a true effect size when all you have is estimations. Depending on the field or issue this might be straighforward (e.g. the methods and approaches are always the same and only the samples differ) or complex (e.g. methods, periods, variables, samples, contexts differ).
